...
public class Exif extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if (action.equals("setlocation")) {
            ...
            try {
                this.exif_f(filename, Double.parseDouble(latitude), Double.parseDouble(longitude), callbackContext);
    ...
    private void exif_f(String filename, Double latitude, Double longitude, CallbackContext callbackContext) {
